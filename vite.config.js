...
const dashboardTheme={name:"imessage-ios-dashboard-theme",transformIndexHtml:{order:"post",handler(html){if(!html.includes('class="platform-layout"')||!html.includes('sidebar-toggle-btn'))return html;return{html,tags:[
