...
const dashboardTheme={name:"imessage-ios-dashboard-theme",transformIndexHtml:{order:"post",handler(html){if(!html.includes('class="platform-layout"')||!html.includes('sidebar-toggle-btn'))return html;return{html,tags:[{tag:"style",children:mobileCss,injectTo:"head"},{tag:"link",attrs:{rel:"stylesheet",href:"/ios-theme.css"},injectTo:"head"},{tag:"link",attrs:{rel:"stylesheet",href:"/ios-polish.css"},injectTo:"head"},{tag:"script",children:mobileJs,injectTo:"body"},{tag:"script",attrs:{src:"/ios-theme.js",defer:true},injectTo:"body"},{tag:"script",attrs:{src:"/ios-polish.js",defer:true},injectTo:"body"}]}}}};
